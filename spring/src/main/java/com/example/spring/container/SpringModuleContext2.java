...
import com.example.spring.test.ChildClass2;
...
public class SpringModuleContext2 implements ApplicationContextAware {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        ConfigurableApplicationContext childContext = new ClassPathXmlApplicationContext("classpath:/child2.xml");
        childContext.setParent(this.parent);
        childContext.refresh();
        ParentClass parentClass = childContext.getBean(ParentClass.class);
        System.out.println(parentClass);

        ChildClass2 bean = childContext.getBean(ChildClass2.class);
